...
![Versione](https://img.shields.io/badge/version-v1.1.0-orange?style=for-the-badge)
...
(Sostituisci "IP_DEL_TUO_SERVER" con l'indirizzo IP numerico del tuo server Linux, ad esempio [http://192.168.1.50:8080](http://192.168.1.50:8080) oppure l'IP pubblico del tuo VPS cloud).
...
Digita questi dati per effettuare l'accesso ed entrare direttamente nella gestione delle ricette.
...
2. Clicca sulla voce "Sicurezza Account" nella sidebar di sinistra.
3. Compila il modulo inserendo la password attuale (admin123) e la nuova chiave personalizzata (minimo 6 caratteri).
4. Premi "Aggiorna Ora". Il sistema genererà automaticamente il nuovo hash di protezione sicuro (password_hash) memorizzandolo nel database senza mai salvarlo in chiaro.
...
## 📈 Sviluppi Futuri della Roadmap (V2)
